"""
Remake of the vertical stack demo from the box2d testbed.
Adaptação: salva cada frame como imagem PNG.
"""
...
class Main(pyglet.window.Window):
    ...
    def on_draw(self):
        ...
        filename = f"frames/frame_{self.frame_count:05d}.png"
